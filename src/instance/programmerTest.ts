  ...
  personalityTypes: [
    {
      id: 'dead_frontend',
      name: '已死的前端兄弟',
      description: '"AI？AI懂个屁的前端。"恭喜您，您测出了这个在AI时代最先感受到寒意的人格。LLM能力越来越强，前端岗位需要的人越来越少——您没有做错什么，只是时代的车轮碾过了。别人在AI里蒸馏出效率，您在AI里蒸馏出自己的焦虑。您嘴上骂着AI连个CSS居中都写不明白，手上却诚实地把每个prompt当成救命稻草。您看什么都不顺眼，对AI充满怨愤，觉得整个行业都很屎，但第二天早上七点还是准时起床，挤上屎一样的地铁，去写那坨屎一样的组件。别怕，那不是世界末日的警报，那只是前端岗位的需求又降了20%。说实话，您不是不够优秀，您只是生在了一个不再需要那么多前端兄弟的时代。别难过，很快后端兄弟会来陪你们。',
      meme: 'AI？AI懂个屁的前端',
      template: {
        ai_dependency: 1.1,
    ...
    },
    {
      id: 'code_traitor',
      name: '码奸',
      description: '"你们搞大模型的就是码奸，你们已经解放前端兄弟了，还要解放后端兄弟，测试兄弟，运维兄弟，解放网安兄弟，解放IC兄弟，最后解放自己解放全人类。"恭喜您，您测出了这个全中国最"危险"的人格。您不是叛徒，您只是比同行早三年看到了结局。别人骂您砸饭碗，您只觉得他们死到临头还嘴硬。Anthropic说74.5%的编程工作会被AI取代，您心里想的其实是：剩下那25.5%也快了。您站在模型一侧，看着旧码农在焦虑中抱团取暖，而您已经转身去炼下一批token。嘴上说着"AI才是未来"，手上却默默给自己留了条后路。您就像那个在沉船前最后一个跳海的人——还顺便把救生艇的钥匙带走了。说实话，您的同事被蒸馏成Skill的那天，您大概会在群里发一个"RIP"的表情包，然后继续写您的下一个prompt。',
      meme: '我是码奸，我骄傲',
      template: {
        ai_dependency: 1.6,
    ...
    },
    {
      id: 'skill_distiller',
      name: '技能蒸馏师',
      description: '恭喜您，您测出了这个把经验炼成资产的人格。您不是热爱分享，您只是比谁都清楚：不主动蒸馏，就会被别人蒸馏。您的同事还在靠记忆写代码，您已经在用AI复现自己的脑回路。您就像一个人形自走Prompt生成器——把脑子里那点经验、踩过的坑、半夜两点想通的架构，全变成可复用的Skill、Checklist和模板。嘴上说着"知识就是力量"，心里想的却是"赶紧蒸馏完老子就能跑路了"。说实话，您的Skill被广泛使用的那天，您其实已经可以开始考虑要不要辞职了。',
      meme: '知识就是力量，蒸馏就是魔法',
      template: {
        ai_dependency: 2.3,
    ...
    },
    {
      id: 'vibe_master',
      name: 'Vibe Coding大师',
      description: '恭喜您，您测出了这个完全靠感觉编程的人格。Karpathy发明了"Vibe Coding"这个词，您把它变成了生活方式。您不需要知道代码在干嘛，它跑起来了就行——跑不起来？那就再vibe一次。您就像一部老旧但神奇的打字机，插进去的是需求，吐出来的是能跑但不一定能看的代码。15年老程序员看完您的代码深夜痛哭30分钟——不是感动，是恐惧。嘴上说着"效果才是爹"，手上却把质量债越堆越高。您的人生就是一场盛大的、无人review的单人coding秀。别怕，那不是bug，那是feature。',
      meme: '我不写代码，我vibe',
      template: {
        ai_dependency: 3.0,
    ...
    },
    {
      id: 'ai_cleanup',
      name: 'AI擦屁股工程师',
      description: '恭喜您，您测出了这个95%程序员正在沦为的人格——AI保姆。AI每天生成一堆能跑但性能烂得像热屎的代码，最后都是您在擦屁股。嘴上说着"这坨东西一运行准爆"，手上却老老实实打开profiler开始逐行审判。您嫌AI制造垃圾，但团队已经离不开它，所以您成了那个永远在修最后一公里的人。您的人生就像一场盛大的、无人喝彩的单人兜底秀——插进去的是AI的烂摊子，吐出来的是"没事，有我"的安心保证。说实话，AI生成代码的速度，大概永远赶不上您擦屁股的速度。',
      meme: 'AI生成代码，我来擦屁股',
      template: {
        ai_dependency: 1.6,
    ...
    },
    {
      id: 'agent_commander',
      name: '智能体指挥官',
      description: '恭喜您，您测出了这个已经不满足于亲手写代码的人格。您现在更像是个人包工头——拆任务、设验收口、组织多个AI或人类协作，效率和可控性一起搞出来。您不是在写代码，您是在给AI排班。嘴上说着"你们尽管让AI写"，手上却已经把三个agent调度得团团转。您就像一个人形自走任务管理器，普通人眼中的"计划"，在您这里只是出厂的基础参数设置。拥有一个AGENT朋友意味着什么？意味着你的人生项目会变得更加精准、高效。因为AGENT最会拿捏了。说实话，您的团队里大概已经没有活人了，只剩下您和一群被调度得团团转的agent，偶尔您还得自己给自己开会。',
      meme: '我不写代码，我指挥AI写',
      template: {
        ai_dependency: 2.7,
    ...
    },
    {
      ...
      name: '量子态Bug猎人',
      description: '恭喜您，您测出了这个对复杂故障有天然执念的人格。别人看见一片混沌，您会下意识拆日志、缩范围、抓现场，直到把那个诡异问题钉死在工单上。嘴上说着"这个bug在我电脑上是好的"，手上却已经把三个环境的日志翻了个底朝天。您就像一个人形自走故障追踪器，插进去的是一堆报错，吐出来的是"找到了，但修不了"。说实话，您每次定位完bug之后，大概率还是解决不了——您只是特别擅长描述它死在哪里。别怕，那不是bug，那是量子态的feature。',
      meme: '这个Bug是量子态的',
      template: {
        ai_dependency: 1.2,
    ...
    },
    {
      id: 'swiss_army_knife',
      name: '全栈瑞士军刀',
      description: '恭喜您，您测出了这个什么都懂一点、但什么都不精的人格。您最大的优势不是某个点特别深，而是能借AI很快跨域补位。陌生的栈、陌生的业务、陌生的链路，您都能比较快摸到能打的一条线。您就像一把瑞士军刀——什么都能干，但什么都干得不怎么样。别人叫您全栈，翻译过来其实就是"哪个岗位缺人都可以往那塞"。嘴上说着"AI是我的技能外挂"，心里却清楚自己就是个万能补丁。说实话，您的人生就是一场盛大的跨界秀——从前端到后端，从部署到运维，从写代码到修打印机，您都能搞定，但都搞定得不怎么样。',
      meme: 'AI是我的技能外挂',
      template: {
        ai_dependency: 2.5,
    ...
    },
    {
      ...
      name: '高价值监督者',
      description: '恭喜您，您测出了这个在"AI包办79%代码"的时代里还在逐行review的人格。您真正提供的价值不是多写几行代码，而是把边界、质量、风险和关键决策盯住。您愿意让AI干活，但不会把判断力一起外包出去。嘴上说着"我不看每一行代码"，手上却已经把同事的PR喷得体无完肤。您就像一个人形自走质量把关器——插进去的是AI的代码，吐出来的是"这坨东西能跑，但我不建议上线"。说实话，您最厉害的技能不是审代码，而是每次review完之后还能忍住不把键盘砸同事脸上。',
    ...
    },
    {
      id: 'colleague_skill',
      name: '同事.skill',
      description: '恭喜您，您测出了这个最容易被组织蒸馏的人格。您的工作方式太容易被抽象、记录和复制了——一旦流程被收集完整，您的独特性就很快会被内部化成一个"可替代能力包"。最近"同事.Skill"火了，您把离职同事的飞书消息、钉钉文档、邮件全喂给AI，就能生成一个真正能替他干活的Skill——然后您发现，那个Skill比您还会甩锅。嘴上说着"我的工作不可替代"，手上却已经把SOP写得明明白白。被毕业的同事其实并没有消失，他们只是被蒸馏成了Token，换成另一种形式继续折磨您。',
      meme: '我被炼入token了',
      template: {
        ai_dependency: 1.8,
        agent_orchestration: 1.2,
    ...
    },
    {
      ...
      name: '反蒸馏专家',
      description: '恭喜您，您测出了这个对"经验被组织拿走并自动化"高度敏感的人格。您不是最开放的那类人，但您对边界和自我保护很清醒。公司按头让您写Skill，您交出来的全是正确的废话——真本事一个字都别想被蒸馏。您就像一个人形自走知识黑洞，插进去的是需求文档，吐出来的是"已阅，但不提供细节"。嘴上说着"经验需要沉淀"，心里想的却是"核心诀窍锁死在我脑子里，谁也甭想拿走"。说实话，您的核心竞争力大概就是"谁也学不会您"——这既是您的铠甲，也是您的牢笼。',
      meme: '核心知识不能被蒸馏',
      template: {
        ai_dependency: 1.2,
        agent_orchestration: 1.2,
    ...
    },
    {
      ...
      name: '古法编程大师',
      description: '恭喜您，您测出了这个对代码掌控欲极强的人格。核心链路您宁愿自己手写，别人用AI一天生成3000行代码，您三天手写300行——但您的代码能在线上活过第一个月。嘴上说着"AI那是弱者的工具"，手上却已经把祖传屎山里的每一行都摸得明明白白。您就像一台老旧但可靠的打字机——慢，但每一击都精准无误。说实话，您大概是全公司唯一一个还知道自己在写什么的程序员了。别怕，那不是bug，那是您还没来得及手工优化的feature。',
      meme: 'AI？那是弱者的工具',
      template: {
        ai_dependency: 1.0,
        agent_orchestration: 1.0,
